  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="container">
      <div class="row" style="margin-top: 10px">
        <div class="col-md-12">
        <h1> DIGITAL TALENT  |<small> Form Verivikasi Peserta Digitalen ( POLITEKNIK BATAM )</small> </h1>
          <div class="alert alert-none" role="alert">
			<form action="cek.php" method="post">
			  ...
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-6">
			      <label for="ps2">Konfirmasi Password </label>
			      <input type="password" class="form-control" id="ps2" name="ps2" placeholder="Masukan Konfirmasi Password" required>
			    </div>
			  </div>
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			  ...
			  <button type="submit" value="cek" class="btn btn-primary">Daftar</button>
			</form>
		</div>
	</div>
</div>
